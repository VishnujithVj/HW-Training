from mongoengine import DynamicDocument, StringField, BooleanField, ListField, IntField, FloatField
from settings import MONGO_COLLECTION_DATA, MONGO_COLLECTION_PRODUCT_URL, MONGO_COLLECTION_CATEGORY, MONGO_COLLECTION_URL_FAILED, MONGO_COLLECTION_RESPONSE
...
class CategoryUrlItem(DynamicDocument):
    ...
    category_title = StringField()
    subcategory_title = StringField()
    category_url = StringField()
    subcategory_url = StringField(required=True)
